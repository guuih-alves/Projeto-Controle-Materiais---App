...
const AddAndUpdateContact2 = ({ isOpen, onClose, isUpdate, contact }) => {
  ...
  const addContact = async (contact) => {   //inserção de dados
    ...
    const userEmail = user.email;
      ...
      const contactRef = collection(db, "terrain-loading-grading");
  ...
  const updateContact = async (contact, id) => {
    try {
      const contactRef = doc(db, "terrain-loading-grading", id);
...
export default AddAndUpdateContact2;
